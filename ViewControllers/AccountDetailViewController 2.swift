...
//        button.alpha = 0.50
    ...
    private func setupLayout() {
        ...
        //                }
        //            }
                    self.consumer = Consumer.init(id: id, name: "王大寶", mobilePhone: "0923233344", dateOfBirth: "1970年1月1日", serialNumber: "A129233444", email: "abc@123.com", address: "台北市大同區", gender: 1, storeId: 1, tags: ["心臟病", "高血壓", "中風"])
                }
        ...
        infoTableView.heightAnchor.constraint(equalToConstant: 400).isActive = true
    ...
    @objc func dateChanged(_ sender: UIDatePicker) {
        ...
        if let day = components.day, let month = components.month, let year = components.year {
            ...
            cell1.answer = "\(year)年\(month)月\(day)日"
