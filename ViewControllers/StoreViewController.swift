...
//        web.load(URLRequest(url: url))
    ...
    override func viewDidLoad() {
        ...
        NetworkManager.fetchStore(id: STOREID) { (store) in
            ...
            DispatchQueue.main.async {
                ...
                self.mainImageView.downloaded(from: store.imageUrl!, group: myGroup) {
                }
...
//        mainImageView.addConstraint(NSLayoutConstraint(item: mainImageView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 100))
        ...
        more.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 20).isActive = true
